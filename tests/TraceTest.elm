module TraceTest exposing (splitAtNodeSuite, suite, traceSuite)

import Bsp.Trace exposing (Side(..), checkBrush, splitAtNode, trace)
...
splitAtNodeSuite =
    describe "Bsp.Trace.splitAtNode"
...
traceSuite =
    describe "Bsp.Trace.trace"
        ...
        , test "segment starting and ending embedded in the wall: allSolid, but fraction is NOT forced to 0" <|
            \_ ->
                -- Known limitation carried over from the tutorial (see Bsp.Trace.trace's
